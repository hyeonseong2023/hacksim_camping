		...
		<>
			<div>
				<div style={{backgroundColor:"rgb(248, 222, 255)"}}>
					제품 이름 : <input type="text" onBlur={handleClickBtn} onClick={handleClickBtn} style={inputStyle} onChange={(e)=>{handleTagName(e)}} value={inputPN} id="inputTNBox" /> 
					제품 링크 : <input type="text" onBlur={handleClickBtn} onClick={handleClickBtn} style={inputStyle} onChange={handleTagLink} value={inputPL} id="inputTLBox"/> <br/>
					제품 카테고리 :
					{
						tagCategoryList && <>
					...
					<button id="cancelTag" type='button' onClick={()=>{setIsCompleted(!isCompleted)}}>취소</button>
					<button id="addTag" type='button' onClick={e=>{e.preventDefault(); setIsCompleted(!isCompleted);
							handleOk(e);
